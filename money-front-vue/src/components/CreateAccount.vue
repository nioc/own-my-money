    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <div class="field">
          ...
          <div class="control">
            <input v-model="account.bankId" v-validate="'required|alpha_num'" class="input" type="text" name="bankIdentifier" :placeholder="$t('fieldnames.bankIdentifier')" :class="{'is-danger': errors.has('bankIdentifier')}">
        ...
        <div class="field">
          ...
          <div class="control">
            <input v-model="account.branchId" v-validate="'required|alpha_num'" class="input" type="text" name="branchIdentifier" :placeholder="$t('fieldnames.branchIdentifier')" :class="{'is-danger': errors.has('branchIdentifier')}">
        ...
        <div class="field">
          ...
          <div class="control">
            <input v-model="account.accountId" v-validate="'required|alpha_num'" class="input" type="text" name="accountIdentifier" :placeholder="$t('fieldnames.accountIdentifier')" :class="{'is-danger': errors.has('accountIdentifier')}">
        ...
        <div class="field">
          ...
          <div class="control">
            <input v-model="account.label" v-validate="'max:30'" class="input" type="text" name="label" :placeholder="$t('fieldnames.label')" :class="{'is-danger': errors.has('label')}">
