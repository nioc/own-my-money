         ...
         <div class="column is-4 is-offset-4">
          <div class="box">
            <form>
              ...
              <div class="field">
                  <div class="control has-icons-left has-icons-right">
                      <input class="input is-medium" type="password" name="password" :placeholder="$t('fieldnames.password')" v-model="credentials.password" v-validate="'required|min:5'" :class="{'input': true, 'is-danger': errors.has('password') }">
                      <span class="icon is-small is-left">
              ...
              <div class="field">
                <button class="button is-block is-primary is-medium is-fullwidth" :class="{ 'is-loading': isLoading }" :disabled="isLoading" @click="submit"><span class="fa fa-sign-in fa-fw" aria-hidden="true"></span>&nbsp;{{ $t('actions.login') }}</button>
              </div>
